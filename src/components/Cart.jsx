...
export default function Cart() {
  const productAddedtoCart = useSelector((state) => state.cart);
  return (
    <>
      <h1 className="mt-20">Hello form the cart</h1>
          ...
          >
            ...
            <div className="ordernow flex flex-row justify-between items-center w-full">
              ...
              <button
                ...
                className="btun4 lg:inline-flex items-center gap-3 hover:bg-red-900 bg-[#abd373] shadow-[10px_10px_150px_#ff9f0d] cursor-pointer py-2 px-4 text-sm font-semibold rounded-full butn mr-4 mt-4"
              >
                Remove from cart
              </button>
            </div>
